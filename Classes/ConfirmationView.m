...
{
	ConfirmationView *loadingView =
		[[[ConfirmationView alloc] initWithFrame:[aSuperview bounds]] autorelease];
	if (!loadingView)
	{
		return nil;
	}
	...
	loadingLabel.text = NSLocalizedString(@"Transaction added", @"Transaction added");
